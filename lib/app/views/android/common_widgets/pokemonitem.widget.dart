import 'package:bitrise_test/app/controllers/favorite.controller.dart';
import 'package:bitrise_test/app/models/pokemonapi.model.dart';
import 'package:bitrise_test/app/views/android/detail/detail.view.dart';
          ...
          child: SizedBox(
            ...
            child: CircleAvatar(
              ...
              backgroundImage: widget.model.sprites!.frontDefault != null ||
                      widget.model.sprites!.other!.officialArtwork!
                              .frontDefault !=
                          null
                  ? NetworkImage(
                      widget.model.sprites!.other!.officialArtwork!
