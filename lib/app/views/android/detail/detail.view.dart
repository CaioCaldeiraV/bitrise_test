import 'dart:async';
import 'package:bitrise_test/app/controllers/pokemon.controller.dart';
import 'package:bitrise_test/app/models/favorite.model.dart';
import 'package:bitrise_test/app/models/pokemonapi.model.dart';
import 'package:bitrise_test/app/repositories/favorite.repository.dart';
                        ...
                        for (var i = 0; i < controller.evolucoes!.length; i++)
                          RichText(
                            text: TextSpan(
                              children: <TextSpan>[
                                TextSpan(
                                  text: capitalize(controller.evolucoes![i]) +
                                      " ",
                                  style: TextStyle(
                                    fontFamily: "OpenSans",
                                    fontWeight: FontWeight.w700,
                                ...
                                TextSpan(
                                  text:
                                      capitalize(controller.typeEvolution![i]),
                                  style: TextStyle(
                                    fontFamily: "OpenSans",
                                    fontWeight: FontWeight.w400,
                                    fontSize: 12,
